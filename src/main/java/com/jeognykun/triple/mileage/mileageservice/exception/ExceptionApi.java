...
public class ExceptionApi {
    ...
    @ExceptionHandler(value = ContentAndPhotoIdNotFoundException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    protected ErrorResponse handleContentNotFoundException(ContentAndPhotoIdNotFoundException e) {
